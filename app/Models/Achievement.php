...
class Achievement extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::updating(function ($achievement) {
            if ($achievement->isDirty('title') && !$achievement->isDirty('slug')) {
                $achievement->slug = Str::slug($achievement->title);
    ...
    /**
     * Scope a query to only include published achievements.
     */
    ...
    /**
     * Scope a query to only include draft achievements.
     */
    ...
    public function getCoverImageUrlAttribute()
    {
        ...
        return asset('assets/images/default-achievement.svg');
    }
    ...
    /**
     * Unpublish the achievement (make it draft).
     */
